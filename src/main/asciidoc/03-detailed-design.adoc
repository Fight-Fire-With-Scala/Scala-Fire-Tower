...
* *GridTheory*: che ricostruisce la griglia di gioco in prolog
...
[#game]
.Immagine del gioco
image::start-game.png[align=center]
...
[#menu]
.Immagine del menu
image::start-screen.png[align=center]
...
----
include::./assets/puml/start.game.protocol.puml
----
