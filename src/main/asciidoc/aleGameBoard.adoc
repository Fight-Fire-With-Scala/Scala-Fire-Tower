...
e i token.
- L'object Grid, che implementa il trait Grid e offre metodi per creare le istanze, come quella vuota, standard o di fine gioco.
Contiene anche la costante per la dimensione della griglia. Le istanze sono definite per comodità in GridDefinitions, che contiene
le configurazioni.
