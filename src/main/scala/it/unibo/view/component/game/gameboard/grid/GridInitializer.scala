...
/** The GridInitializer object is responsible for initializing the grid squares in the game grid. It
  * creates the grid squares, sets their positions, and adds them to the grid pane.
  */
