 ...
 *
 * @param _squareMap A mutable map of `Position` to `GridSquare`.
...
class GridHoverHandler(using _squareMap: mutable.Map[Position, GridSquare], gridState: GridState):
   ...
   *
   * @param position       The position of the cell hovering.
   * @param hoverDirection The direction of the hover.
   */
   ...
   * @param token    The token to be used for updating the color.
   */
   ...
   *
   * @param startPosition  The starting position of the cell.
   * @param hoverDirection The direction of the hover.
   * @return The position of the neighboring cell.
   */
