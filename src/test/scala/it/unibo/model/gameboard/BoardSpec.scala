...
//
//      val updatedGameBoard = gameBoard.solveChoice(Card(0, cardType), WindEffect.UpdateWind)
...
//        .solveChoice(Card(0, cardType), WindEffect.RandomUpdateWind)
...
////
////      val updatedGameBoard = gameBoard.solveCardPlayed(Card(0, cardType), WindChoice.PlaceFire)
////      updatedGameBoard.board.windDirection shouldBe WindEffect(Direction.North)
////    }
//
////  "Playing a card with Wind effect and multi-step solver" should
...
////          ) // Assuming PlaceFire triggers multi-step solver
